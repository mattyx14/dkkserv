...
local trapRemoveItem = MoveEvent()
...
function trapRemoveItem.onRemoveItem(item, tile, position)
...
trapStepOut:id(1511, 4209)
trapRemoveItem:id(2579)
trapStepIn:register()
trapStepOut:register()
trapRemoveItem:register()
