function onStepIn(cid, item, pos)
	APPLE_ID = 2674
	ACTION_ID = 10102 -- Actionid of the tile that teleport you if you have an apple
	if (item.actionid == 10102) then
		Dmg_Random = math.random(100,500)
		if (getPlayerItemCount(cid, 2674) ~= 0) then
			doTeleportThing(cid, {x=500, y=462, z=7})
			doPlayerRemoveItem(cid, 2674 ,0)
		else
			doTeleportThing(cid, {x=500, y=460, z=7})
