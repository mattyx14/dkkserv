local config = {
	[9006] = {flamePosition = Position(973, 1033, 7), toPosition = Position(973, 1034, 6), sacrificeItem = 7408,
		setStore = Storage.FirstSacrifice.noSacrifice.fangWyvern}, -- wyvern fang
	[9007] = {flamePosition = Position(975, 949, 8), toPosition = Position(1034, 913, 8), sacrificeItem = 2430,
		setStore = Storage.FirstSacrifice.noSacrifice.axeKnight}, -- knight axe
	[9008] = {flamePosition = Position(569, 1256, 6), toPosition = Position(631, 1248, 6), sacrificeItem = 2434,
		setStore = Storage.FirstSacrifice.noSacrifice.hammerDragon}, -- dragon hammer
}
...
function onAddItem(moveitem, tileitem, position)
	...
	moveitem:remove()
	player:setStorageValue(targetCoalBasin.setStore, 1)
