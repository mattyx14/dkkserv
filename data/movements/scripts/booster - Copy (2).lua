local timeToRemove = 120 --Minutes ~
local itemID = 2196
local msg = "Give 1x more exp"
local msg30 = "You have to be level 200 or higher"
...
function onEquip(cid, item, slot)
    ...
    if item.itemid == itemID and getPlayerLevel(cid) >= 200 then
