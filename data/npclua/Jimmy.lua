...
local function creatureSayCallback(npc, creature, type, message)
	...
	local addonProgress = player:getStorageValue(DarkKonia.OutfitQuest.Citizen.AddonBackpack)
	if MsgContains(message, 'addon') or MsgContains(message, 'outfit')
		...
		elseif addonProgress == 2 then
			if player:getStorageValue(DarkKonia.OutfitQuest.Citizen.AddonBackpackTimer) < os.time() then
				...
				player:setStorageValue(DarkKonia.OutfitQuest.Citizen.MissionBackpack, 0)
				player:setStorageValue(DarkKonia.OutfitQuest.Citizen.AddonBackpack, 3)
	...
	elseif npcHandler:getTopic(playerId) == 2 then
		if MsgContains(message, 'yes') then
			...
			player:setStorageValue(DarkKonia.OutfitQuest.Citizen.AddonBackpack, 1)
			player:setStorageValue(DarkKonia.OutfitQuest.Citizen.MissionBackpack, 1)
	...
	elseif npcHandler:getTopic(playerId) == 3 then
		if MsgContains(message, 'yes') then
			if player:getItemCount(5878) < 100 then
				...
				player:setStorageValue(DarkKonia.OutfitQuest.Citizen.MissionBackpack, 2)
				player:setStorageValue(DarkKonia.OutfitQuest.Citizen.AddonBackpack, 2)
				player:setStorageValue(DarkKonia.OutfitQuest.Citizen.AddonBackpackTimer, os.time() + 2 * 60 * 60)
			end
		else
