local config = {
	...
	["second knight addon"] = {
		male = 131, female = 139, addon = 2, items = {{5893, 100}, {5924, 1}, {5885, 1}, {5887, 1}, {5902, 20}}
	},
	["first mage addon"] = {
		male = 130, female = 141, addon = 1, items = {{2182, 1}, {2186, 1}, {2185, 1}, {2181, 1}, {2183, 1}, {2190, 1}, {2191, 1}, {2188, 1}, {2189, 1}, {2187, 1}, {5904, 10}, {2193, 20}, {5809, 1}}
	},
	["second mage addon"] = {
	...
	["second summoner addon"] = {
		male = 133, female = 138, addon = 2, items = {{5894, 70}, {5911, 20}, {5883, 10}, {5922, 50}, {5886, 10}, {5881, 50}, {5882, 50}, {5904, 20}, {5905, 20}}
	},
	["first warrior addon"] = {
		male = 134, female = 142, addon = 1, items = {{5925, 100}, {5899, 100}, {5884, 5}, {5919, 5}}
	},
	["second warrior addon"] = {
		male = 134, female = 142, addon = 2, items = {{5880, 100}, {5887, 2}, {2475, 10}}
	},
	...
	["second oriental addon"] = {
		male = 146, female = 150, addon = 2, items = {{5883, 50}, {5895, 100}, {5891, 10}, {5912, 50}}
	},
}
