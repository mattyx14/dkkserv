local mType = Game.createMonsterType("shazarus")
local monster = {}

monster.name = "Shazarus"
monster.description = "a shazarus"
monster.experience = 50200
monster.outfit = {
	lookType = 12,
	lookHead = 80,
	lookBody = 70,
...
monster.summons = {
	{name = "undead dragon", chance = 20, interval = 2000},
	{name = "blightwalker", chance = 15, interval = 2000},
