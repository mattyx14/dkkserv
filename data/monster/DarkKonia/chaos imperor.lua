local mType = Game.createMonsterType("chaos imperor")
local monster = {}

monster.name = "chaos imperor"
monster.description = "a chaos imperor"
...
monster.summons = {
	{name = "firelord", chance = 100, interval = 5000, max = 4}
}
