local mType = Game.createMonsterType("Atlantian Elite")
local monster = {}

monster.name = "Atlantian Elite"
monster.description = "a Atlantian Elite"
...
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = -380, maxDamage = -690},
	...
	{name ="combat", interval = 1800, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -130, maxDamage = -455, range = 7, radius = 5, target = false, effect = CONST_ME_ICEATTACK},
	{name ="combat", interval = 2500, chance = 15, type = COMBAT_ICEDAMAGE, minDamage = -230, maxDamage = -355, range = 7, radius = 5, target = false, effect = CONST_ME_ICEATTACK}
}
...
monster.loot = {
	...
	{name = "Green Gem", chance = 12300},
	{name = "Blue Gem", chance = 13010},
	{name = "Crystal Mace", chance = 5580},
