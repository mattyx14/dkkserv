...
monster.attacks = {
	...
	{name ="combat", interval = 2000, chance = 17, type = COMBAT_LIFEDRAIN, minDamage = -4, maxDamage = -6, range = 7, ShootEffect = CONST_ANI_SUDDENDEATH, effect = CONST_ME_YALAHARIGHOST},
