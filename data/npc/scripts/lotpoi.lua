...
shopModule:addSellableItem({'magic longsword'}, 2390, 1000000, 'magic longsword')
shopModule:addSellableItem({'ice rapier'}, 2396, 25000, 'ice rapier')
shopModule:addSellableItem({'magic sword'}, 2400, 500000, 'magic sword')
shopModule:addSellableItem({'warlord sword'}, 2408, 350000, 'warlord sword')
shopModule:addSellableItem({'great axe'}, 2415, 400000, 'great axe')
shopModule:addSellableItem({'thunder hammer'}, 2421, 50000, 'thunder hammer')
shopModule:addSellableItem({'stonecutter axe'}, 2431, 190000, 'stonecutter axe')
shopModule:addSellableItem({'arcane staff'}, 2453, 400000, 'arcane staff')
shopModule:addSellableItem({'avenger'}, 6528, 290000, 'avenger')
shopModule:addSellableItem({'ruthless axe'}, 6553, 75000, 'ruthless axe')
shopModule:addSellableItem({'demonrage sword'}, 7382, 120000, 'demonrage sword')
shopModule:addSellableItem({'blade the legend'}, 7391, 500000, 'blade the legend')
shopModule:addSellableItem({'jade hammer'}, 7422, 290000, 'jade hammer')
shopModule:addSellableItem({'skullcrusher'}, 7423, 500000, 'skullcrusher')
shopModule:addSellableItem({'demonbone'}, 7431, 130000, 'demonbone')
shopModule:addSellableItem({'glorious axe'}, 7454, 290000, 'glorious axe')
shopModule:addSellableItem({'hellforged axe'}, 8924, 240000, 'hellforged axe')
shopModule:addSellableItem({'solar axe'}, 8925, 450000, 'solar axe')
shopModule:addSellableItem({'demonwing axe'}, 8926, 150000, 'demonwing axe')
shopModule:addSellableItem({'dark trinity mace'}, 8927, 200000, 'dark trinity mace')
shopModule:addSellableItem({'obsidian truncheon'}, 8928, 450000, 'obsidian truncheon')
shopModule:addSellableItem({'stomper'}, 8929, 190000, 'stomper')
shopModule:addSellableItem({'emerald sword'}, 8930, 240000, 'emerald sword')
shopModule:addSellableItem({'flame blade'}, 8931, 4450000, 'flame blade')
shopModule:addSellableItem({'dragon scale legs'}, 2469, 80000, 'dragon scale legs')
shopModule:addSellableItem({'golden legs'}, 2470, 80000, 'golden legs')
shopModule:addSellableItem({'golden helmet'}, 2471, 95000, 'golden helmet')
shopModule:addSellableItem({'magic plate armor'}, 2472, 150000, 'magic plate armor')
shopModule:addSellableItem({'winged helmet'}, 2474, 80000, 'winged helmet')
shopModule:addSellableItem({'demon helmet'}, 2493, 180000, 'demon helmet')
shopModule:addSellableItem({'demon armor'}, 2494, 550000, 'demon armor')
shopModule:addSellableItem({'demon legs'}, 2495, 650000, 'demon legs')
shopModule:addSellableItem({'demon shield'}, 2520, 60000, 'demon shield')
shopModule:addSellableItem({'Phoenix Shield'}, 2539, 100000, 'phoenix shield')
shopModule:addSellableItem({'horned helmet'}, 2496, 750000, 'horned helmet')
shopModule:addSellableItem({'golden boots'}, 2646, 850000, 'golden boots')
shopModule:addSellableItem({'ferumbras hat'}, 5903, 450000, 'ferumbras hat')
shopModule:addSellableItem({'yalahari armor'}, 9776, 450000, 'yalahari armor')
shopModule:addSellableItem({'yalahari leg piece'}, 9777, 450000, 'yalahari leg piece')
shopModule:addSellableItem({'yalahari mask'}, 9778, 450000, 'yalahari mask')
...
shopModule:addSellableItem({'titan axe'}, 7413, 55000, 'titan axe')
shopModule:addSellableItem({'bonebreaker'}, 7428, 35000, 'bonebreaker')
...
shopModule:addSellableItem({'focus cape'}, 8871, 35000, 'focus cape')
...
shopModule:addSellableItem({'zaoan sword'}, 11307, 35000, 'zaoan sword')
shopModule:addSellableItem({'drachaku'}, 11308, 35000, 'drachaku')
shopModule:addSellableItem({'zaoan halberd'}, 11326, 15000, 'zaoan halberd')
