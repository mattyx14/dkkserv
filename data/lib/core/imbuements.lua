...
Imbuements_Weapons = {
	...
	["axe"] = {15404, 2429, 3962, 7412, 18451, 8926, 2414, 11305, 7419, 2435, 7453, 2415, 2427, 7380, 8924, 7389, 15492, 7435, 2430, 7455, 7456, 2443, 25383, 6553, 8925, 2447, 22405, 22408, 22406, 22409, 2454, 15451, 11323}, --ok
	["club"] = {7414, 7426, 2453, 2423, 7415, 2445, 15647, 7431, 7430, 23543, 2444, 2452, 20093, 7424, 25418, 18452, 8928, 7421, 7392, 15414, 7410, 7437, 7451, 2424, 7423, 12648, 7452, 8929, 22414, 22411, 22415, 22412, 2391}, --ok
	["sword"] = {7404, 7403, 7406, 12649, 7416, 2413, 7385, 7382, 2451, 7402, 8930, 2438, 32423, 2393, 7407, 7405, 7384, 7418, 7383, 7417, 18465, 2383, 2376, 7391, 6528, 8931, 12613, 11309, 22399, 22403, 22400, 22402, 7408, 11307, 35233}, --ok
	...
	["special_wand"] = {35234},
	["special_rod"] = {35235},
	["elemental_swords"] = {30685, 30684, 25919, 2400, 2407, 7390, 30886, 34059, 34060, 36449},
	["elemental_axes"] = {30687, 30686, 2431, 2432, 7434, 32424, 35231},
	["elemental_clubs"] = {30689, 30688, 2421, 2436, 7429, 32425, 34057, 35230, 36415},
...
local equipitems = {
	["lich shroud"] = {"armor", "armor_energy", "armor_only_energy", "armor_ice", "armor_earth", "spellbooks", "shield", "armor_fire", "armor_multi", "armor_multi_two"},
	["reap"] = {"axe", "club", "sword"},
	...
	["cloud fabric"] = {"armor", "armor_earth", "armor_death", "spellbooks", "shield", "armor_fire", "armor_multi"},
	["electrify"] = {"axe", "club", "sword"},
	["swiftness"] = {"boots"},
	["snake skin"] = {"armor", "armor_energy", "armor_only_energy", "armor_ice", "armor_death", "spellbooks", "shield", "armor_fire", "armor_multi"},
	["venom"] = {"axe", "club", "sword"},
	["slash"] = {"sword", "helmet", "elemental_swords"},
	["chop"] = {"axe", "helmet", "elemental_axes"},
	["bash"] = {"club", "helmet", "elemental_clubs"},
	["hide dragon"] = {"armor", "armor_energy", "armor_only_energy", "armor_ice", "armor_death", "spellbooks", "shield", "armor_multi_two"},
