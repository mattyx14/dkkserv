...
local portalStatueDracula = Action()
function portalStatueDracula.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
portalStatueDracula:aid(39517)
portalStatueDracula:register()
