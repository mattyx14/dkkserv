local outfits = {
	...
	[7460] = {7460, 'Norse', 252, 251, 7460},
	[15545] = {15545, 'Deepling', 464, 463, 15545},
...
local outfitQuests = Action()
function outfitQuests.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
outfitQuests:uid(2662, 3697, 5807, 6096, 7431, 7460, 8267, 8820, 9933, 10008, 15545)
outfitQuests:register()
