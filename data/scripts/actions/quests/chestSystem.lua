...
local chestSystem = Action()
function chestSystem.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
chestSystem:aid(2000, 2001, 2002)
chestSystem:register()
