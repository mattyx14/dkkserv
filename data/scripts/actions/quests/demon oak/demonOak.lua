...
local demonOakScript = Action()
function demonOakScript.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
demonOakScript:uid(9009)
demonOakScript:register()
