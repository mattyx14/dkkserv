...
local conjurerLever = Action()
function conjurerLever.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
conjurerLever:aid(2080)
conjurerLever:register()
