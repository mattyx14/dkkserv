...
local conjurerLeverTwo = Action()
function conjurerLeverTwo.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
conjurerLeverTwo:aid(2081)
conjurerLeverTwo:register()
