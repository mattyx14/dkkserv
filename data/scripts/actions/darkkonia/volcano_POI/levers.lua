...
local volcanoPOILevers = Action()
function volcanoPOILevers.onUse(player, item, fromPosition, target, toPosition, isHotkey)
...
for actionRange = 9011, 9020 do
	volcanoPOILevers:aid(actionRange)
end
volcanoPOILevers:register()
