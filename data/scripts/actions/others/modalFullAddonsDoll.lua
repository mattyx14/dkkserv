...
local modalFullAddonsDoll = Action()
function modalFullAddonsDoll.onUse(player,item, fromPosition,itemEx,toPosition,isHotkey)
...
modalFullAddonsDoll:id(8982)
modalFullAddonsDoll:register()
