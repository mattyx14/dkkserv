...
local modalMountDoll = Action()
function modalMountDoll.onUse(player, item, fromPosition, itemEx, toPosition, isHotkey)
...
modalMountDoll:id(9019)
modalMountDoll:register()
