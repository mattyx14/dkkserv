...
local firstSacrificeWF = MoveEvent()
function firstSacrificeWF.onStepIn(creature, item, position, fromPosition)
...
firstSacrificeWF:type("stepin")
firstSacrificeWF:aid(9006)
firstSacrificeWF:register()
