...
local firstSacrificeKA = MoveEvent()
function firstSacrificeKA.onStepIn(creature, item, position, fromPosition)
...
firstSacrificeKA:type("stepin")
firstSacrificeKA:aid(9007)
firstSacrificeKA:register()
