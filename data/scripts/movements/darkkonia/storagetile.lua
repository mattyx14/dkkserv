local TileSettings = {
	...
	[5510] = { -- Require First Sacrifice Wyvern Fang
		minLevel = 50,
		mission = DarkKonia.FirstSacrifice.noSacrifice.fangWyvern,
	...
	[5511] = { -- Require First Sacrifice Dragon Hammer 
		minLevel = 50,
		mission = DarkKonia.FirstSacrifice.noSacrifice.hammerDragon,
	...
	[5513] = { -- Fynn Castle "Fury Trap"
		minLevel = 800,
		mission = DarkKonia.AnniQuest.AnnihiMission.Done,
	...
	[5515] = { -- Elfic Ville / Magic Academy
		minLevel = 80,
		mission = DarkKonia.HidenChest.nobleArmor,
