...
local firstSacrificeDH = MoveEvent()
function firstSacrificeDH.onStepIn(creature, item, position, fromPosition)
...
firstSacrificeDH:type("stepin")
firstSacrificeDH:aid(9008)
firstSacrificeDH:register()
