local monsterHealDeath = CreatureEvent("MonsterHealDeathDamage")
local monsterHealDrown = CreatureEvent("MonsterHealDrownDamage")
local monsterHealEarth = CreatureEvent("MonsterHealEarthDamage")
local monsterHealEnergy = CreatureEvent("MonsterHealEnergyDamage")
local monsterHealFire = CreatureEvent("MonsterHealFireDamage")
local monsterHealHoly = CreatureEvent("MonsterHealHolyDamage")
local monsterHealIce = CreatureEvent("MonsterHealIceDamage")
local monsterHealPhysical = CreatureEvent("MonsterHealPhysicalDamage")
